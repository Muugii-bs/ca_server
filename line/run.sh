...
./reconstruct -train keywords.txt -output net_youtube_dense.txt -depth 2 -k-max 1000
./line -train net_youtube_dense.txt -output vec_1st_wo_norm.txt -binary 1 -size 8 -order 1 -negative 5 -samples 10000 -threads 40
./line -train net_youtube_dense.txt -output vec_2nd_wo_norm.txt -binary 1 -size 8 -order 2 -negative 5 -samples 10000 -threads 40
...
./concatenate -input1 vec_1st.txt -input2 vec_2nd.txt -output vec_all.txt
